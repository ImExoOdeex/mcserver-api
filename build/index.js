...
var getBedrockServerInfo_1 = require("./getBedrockServerInfo");
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, getServerInfo_1.getServerInfo)(name)];
            case 1:
                _b.apply(_a, [_c.sent()]);
                return [2 /*return*/];
        }
...
app.get("/bedrock/:name", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var name, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                name = req.params.name;
                _b = (_a = res.status(200)).send;
                return [4 /*yield*/, (0, getBedrockServerInfo_1.getBedrockServerInfo)(name)];
            case 1:
                _b.apply(_a, [_c.sent()]);
                return [2 /*return*/];
        }
